...
// WICS 중분류(코드 앞 5자리 = 'G' + GICS 산업그룹 4자리) — 네이버는 업종명만 주므로
// 이름은 여기서 붙인다. 28종.
//   ⚠️ 4자리로 자르면 안 된다. G4530(반도체와반도체장비)과 G4535(전기제품)가 'G453'으로
//   합쳐져, LG에너지솔루션·삼성SDI 같은 2차전지주가 '반도체와반도체장비'로 찍힌다(실측).
// GICS 산업그룹 체계를 따르되 한국 시장에 맞춰 증권·교육서비스·전기제품·디스플레이가 따로 있고,
// 부동산(G4050)은 별도 섹터가 아니라 금융(G40) 아래 중분류다 — GICS와 다른 점.
const WICS_MIDS = {
  G1010: '에너지',                G1510: '소재',
  G2010: '자본재',                G2020: '상업서비스와공급품',  G2030: '운송',
  G2510: '자동차와부품',          G2520: '내구소비재와의류',    G2530: '호텔·레스토랑·레저',
  G2550: '소매(유통)',            G2560: '교육서비스',
  G3010: '식품과기본식료품소매',   G3020: '식품·음료·담배',      G3030: '가정용품과개인용품',
  G3510: '건강관리장비와서비스',   G3520: '제약·생물공학·생명과학',
  G4010: '은행',                  G4020: '증권',                G4030: '다각화된금융',
  G4040: '보험',                  G4050: '부동산',
  G4510: '소프트웨어와서비스',     G4520: '기술하드웨어와장비',   G4530: '반도체와반도체장비',
  G4535: '전기·전자제품',          G4540: '디스플레이',
