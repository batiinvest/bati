...
function _rpfRowDefs() {
  ...
  const defs = {
    is: [
      ...
      { k: '_gpm',                    label: '매출총이익률(GPM)',     pct: 1, calc: r => { const gp = gpCalc(r); return gp != null && r.revenue ? gp / r.revenue * 100 : null; } },
      { k: '_cogsr',                  label: '매출원가율',            pct: 1, calc: r => r.cogs != null && r.revenue ? r.cogs / r.revenue * 100 : null },
      { k: '_sgar',                   label: '판관비율',              pct: 1, calc: r => r.sga != null && r.revenue ? r.sga / r.revenue * 100 : null },
