...
function go(page) {
  ...
  const t = { overview:'전체 현황', rooms:'채팅방 관리', notice:'전체 공지', logs:'동기화 로그', bot:'봇 모니터링', botconfig:'봇 설정', stocks:'종목 관리', team:'팀원 관리', settings:'설정' };
...
function draw() {
  ...
  const pages = { overview:pOverview, rooms:pRooms, notice:pNotice, logs:pLogs, bot:pBot, botconfig:pBotConfig, stocks:pStocks, team:pTeam, settings:pSettings };
